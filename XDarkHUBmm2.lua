...
xpcall(function()
    ...
    local function softGlow(posX, posY, size, color)
        for i = 1, 3 do
            ...
            b.BorderSizePixel = 0; b.ZIndex = 0
            b.Parent = frame
            corner(b, s/2)
        end
    end
    ...
    for i = 1, 24 do
        ...
        ember.BorderSizePixel = 0; ember.ZIndex = 0
        ember.Parent = frame
        corner(ember, sz)
        xdSpawn(function()
    ...
    for _, isTop in ipairs({true, false}) do
        ...
        shade.BorderSizePixel = 0; shade.ZIndex = 1
        shade.Parent = frame
        pcall(function()
    ...
    topBar.BorderSizePixel = 0; topBar.Active = true; topBar.ZIndex = 2
    topBar.Parent = frame
    ...
    logoRing.BorderSizePixel = 0; logoRing.ZIndex = 4
    ...
    logo.BorderSizePixel = 0; logo.ZIndex = 5
    ...
    sideLine.BorderSizePixel = 0; sideLine.ZIndex = 3
    ...
    local function addTab(name, icon, order)
        ...
        b.LayoutOrder = order; b.ZIndex = 4
        b.Parent = tabScroll
        corner(b, 10)
        ...
        indicator.BorderSizePixel = 0; indicator.ZIndex = 5
        indicator.Parent = b
        corner(indicator, 2)
    ...
    makeButton(visC, 11, "🔥 ВКЛЮЧИТЬ ВСЁ", COL.accent, function()
        for _, t in pairs(visualToggles) do t:Set(true) end
        notify("XDarkHUB", "Все эффекты включены!")
    end)
    makeButton(visC, 12, "🧹 ВЫКЛЮЧИТЬ ВСЁ", Color3.fromRGB(70, 70, 80), function()
