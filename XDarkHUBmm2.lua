...
-- ═══════════════════════════════════════════════════════════════════════════════
do local old = CoreGui:FindFirstChild("XDarkHUB_GUI") if old then old:Destroy() end end
...
if not guiUI.Parent then guiUI.Parent = CoreGui end
...
local function createTabContent(name)
    ...
    p.PaddingRight = UDim2.new(0, 25)
    p.PaddingTop = UDim2.new(0, 20)
    p.PaddingBottom = UDim2.new(0, 20)
    local l = Instance.new("UIListLayout", c)
    l.SortOrder = Enum.SortOrder.LayoutOrder
    l.Padding = UDim2.new(0, 12)
    tabContents[name] = c
end
...
print("[XDarkHUB] Скрипт загружен успешно!")
